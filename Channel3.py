Fs_RX = 44100
ABS1 = wavaudioread("Recording-5-1cm.wav", Fs_RX)
ABS2 = wavaudioread("Recording-5-50cm.wav", Fs_RX)
ABS3 = wavaudioread("Recording-5-1m.wav", Fs_RX)

#########Plotting transmit sequence and its spectrum
refsig, _ = refsignal(Nbits, Timer0, Timer1, Timer3, code, Fs_TX)
FTrefsig = fft(refsig)
