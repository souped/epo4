...
'''''
# speed=14
df=np.loadtxt("C:/Users/Jesse/OneDrive/epo4/Distancedata/dtw_speed10.csv",delimiter=',')
...
ax.plot(df[20:30,2],df[20:30,0], label='Left sensor distance')
ax.plot(df[20:30,2],df[20:30,1], label='Right sensor distance')
ax2 = ax.twinx()
ax2.plot(df[20:30,2],df[20:30,3]*1000, label='Delay', color="C2", linestyle='--')
ax.legend(loc=0)
ax.grid()
